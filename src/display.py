...
def drawDefault():
    ...
    Default.append(rect_1)
    # Volup
    image_Volup_tile = displayio.TileGrid(image_Volup_bits, pixel_shader=image_Volup_bits.pixel_shader, position=(3, 2))
    Default.append(image_Volup_tile)
    # imgbitmap.png
    image_imgbitmap_png_tile = displayio.TileGrid(image_imgbitmap_png_bits, pixel_shader=image_imgbitmap_png_bits.pixel_shader, position=(117, 2))
...
display.root_group = media__play_icon_
...
def drawmedia__play_icon_():
    ...
    # music_play
    image_music_play_tile = displayio.TileGrid(image_music_play_bits, pixel_shader=image_music_play_bits.pixel_shader, position=(61, 42))
...
display.root_group = media__pause_icon_
